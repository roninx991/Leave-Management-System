...
<body>
	...
	$sql="SELECT * FROM `StaffApps` WHERE AppID='".$_GET["id"]."'";
	...
	<br><br>
	<center>
	<form action="DisApphod.php" id="leaveform" method="POST">
			<div>
				<h3>Application ID</h3>
				<input type="text" name="id" value=<?php echo "'".$row['AppID']."'";?> ><hr>
			</div>
			<div>
				<h3>Reason(s) and Dates for leave: </h3>
		...
		<div class="modal-footer">
			<input type="submit" class="btn btn-danger" name="dis" value="Disapprove">
